"""onfiguration file for the second quasipotential experiment - configs/quasipotential_ex2.py"""
...
def get_config():
   ...
   data.domain = [[-0.5, 2.5], [1.0, 4.0]]
   data.num_channels = 2  # Same as the dim, for compatibility
   ...
   model.dim = 2 # Input/output dimentions
