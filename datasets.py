...
def get_toy_2d_dataset(config, evaluation=False):
  """Create a clean 2D toy dataset using toy_dataset.py."""
  
  print(f"[DEBUG] Using clean toy_dataset.py implementation")
  
  # Use the clean implementation from toy_dataset.py
  train_loader, test_loader, _ = get_data_loaders(config)
  
  # Convert to iterators expected by run_lib.py
  train_iter = dataloader_to_iterator(train_loader)
  test_iter = dataloader_to_iterator(test_loader)
  
  return train_iter, test_iter, None